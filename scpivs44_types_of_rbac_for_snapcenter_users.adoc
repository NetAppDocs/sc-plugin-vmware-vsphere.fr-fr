...
* Vous pouvez associer un utilisateur à des rôles prédéfinis sous des autorisations globales.
...
+
Au minimum, tous les utilisateurs doivent pouvoir afficher les objets vCenter.  Sans ce privilège, les utilisateurs ne peuvent pas accéder à l’interface utilisateur du client VMware vSphere.
