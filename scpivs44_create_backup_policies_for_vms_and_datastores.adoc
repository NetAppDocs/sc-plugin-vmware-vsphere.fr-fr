...
---
= Créez des stratégies de sauvegarde pour les machines virtuelles et les banques de données dans le SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
Pour plus d'informations sur la manière dont les administrateurs attribuent des ressources aux utilisateurs, reportez-vous à https://docs.netapp.com/us-en/snapcenter/get-started/rbac-snapcenter.html["Informations SnapCenter sur l'utilisation du contrôle d'accès basé sur des rôles"^] .
