...
---
= Accédez aux API REST à l'aide de la page web de l'API Swagger pour le SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Avant de commencer
Pour accéder aux API REST du SnapCenter Plug-in for VMware vSphere , assurez-vous de disposer de l'adresse IP ou du nom d'hôte du SnapCenter Plug-in for VMware vSphere.
