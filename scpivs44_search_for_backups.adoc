...
---
= Recherchez les sauvegardes dans le SnapCenter Plug-in for VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Étapes
. Dans l’interface utilisateur du client VMware vSphere, sélectionnez *Menu* dans la barre d’outils, puis effectuez l’une des opérations suivantes :
+
|===
