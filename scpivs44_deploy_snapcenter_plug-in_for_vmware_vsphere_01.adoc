...
Suivez les instructions de la section link:scpivs44_download_the_ova_open_virtual_appliance.html["Télécharger Open Virtual Appliance (OVA)"^] Pour télécharger les fichiers OVA.
