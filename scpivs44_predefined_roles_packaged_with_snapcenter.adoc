...
---
= Rôles prédéfinis fournis avec le SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Vous pouvez voir les rôles prédéfinis dans l'interface utilisateur de vCenter en sélectionnant *Menu > Administration > Rôles* comme indiqué dans le tableau suivant.
