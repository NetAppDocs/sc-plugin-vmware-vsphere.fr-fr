...
---
= Flux de travail de l'API REST pour restaurer des machines virtuelles à l'aide du SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Pour restaurer les sauvegardes de machines virtuelles avec le SnapCenter Plug-in for VMware vSphere , suivez la séquence requise d'appels d'API REST comme indiqué ci-dessous.
