...
. Dans l'onglet *Résumé* de l'appliance virtuelle, cliquez sur *lancer la console distante ou lancer la console Web* pour ouvrir une fenêtre de console de maintenance, puis connectez-vous.
+
