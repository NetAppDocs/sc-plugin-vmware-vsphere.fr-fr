...
---
= Supprimez le SnapCenter Plug-in pour VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Étapes
. Connectez-vous à l'interface utilisateur de gestion du SnapCenter Plug-in for VMware vSphere en utilisant le format `\https://<OVA-IP-address>:8080` .
+
