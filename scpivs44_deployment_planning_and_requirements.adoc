...
---
= Planification du déploiement et exigences relatives au SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
| Outils ONTAP pour VMware | Le SnapCenter Plug-in for VMware vSphere l'utilise pour gérer les banques de données vVol (volumes virtuels VMware). Pour les versions prises en charge, reportez-vous à https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["Matrice d'interopérabilité NetApp"^] . 


| Stockage Amazon FSxN pour NetApp ONTAP | 9.10 et plus 
|===
Pour obtenir les dernières informations sur les versions prises en charge, reportez-vous à https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["Matrice d'interopérabilité NetApp"^] .
