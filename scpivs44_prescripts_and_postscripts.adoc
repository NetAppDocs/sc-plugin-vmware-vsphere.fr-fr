...
---
= Prescripts et postscripts pour le SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Un chemin de script PERL peut être `/support/support/script.pl`
...
Vérifiez les éléments suivants pour vérifier que les valeurs du script sont renseignées :
