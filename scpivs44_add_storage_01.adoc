...
---
= Ajoutez des systèmes de stockage au SnapCenter Plug-in for VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Quelle interface utilisateur utiliser
+
...
NOTE: Si vous utilisez le SnapCenter Plug-in for VMware vSphere pour prendre en charge les sauvegardes basées sur des applications sur des VMDK, vous devez utiliser l'interface utilisateur SnapCenter pour saisir les détails d'authentification de stockage et enregistrer les systèmes de stockage.
