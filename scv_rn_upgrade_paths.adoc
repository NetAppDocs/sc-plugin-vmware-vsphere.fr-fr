...
---
= Chemins de mise à niveau du SnapCenter Plug-in pour VMware vSphere
:allow-uri-read: 
...
[NOTE]
====
La mise à niveau vers le SnapCenter Plug-in pour VMware vSphere (SCV) 4.8 et versions ultérieures est prise en charge uniquement sur VMware vCenter Server 7 update 1 et versions ultérieures. Pour VMware vCenter Server antérieur à la version 7 update 1, vous devez continuer à utiliser SCV 4.7.
