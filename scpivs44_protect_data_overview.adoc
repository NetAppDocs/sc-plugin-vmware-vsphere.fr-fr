...
---
= Flux de travail de protection des données pour le SnapCenter Plug-in for VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Améliorez la protection VMware grâce à NetApp Backup and Recovery, qui offre la sauvegarde 3-2-1, la protection contre les ransomwares, la gestion des sauvegardes automatisée, une meilleure évolutivité, des coûts réduits et une gestion centralisée de plusieurs instances vCenter. Vous pouvez migrer les stratégies, les snapshots et les planifications SCV vers NetApp Backup and Recovery et gérer toute la protection des machines virtuelles depuis une console unique. Pour plus d'informations, consultez link:https://docs.netapp.com/us-en/data-services-backup-recovery/["Documentation NetApp Backup and Recovery"].
...
Dans les configurations NetApp MetroCluster :
