...
keywords:  
summary: 'Si vous ne connaissez pas le mot de passe administrateur de l"interface utilisateur de gestion du SnapCenter Plug-in for VMware vSphere , vous pouvez définir un nouveau mot de passe à partir de la console de maintenance.' 
---
= Modifiez le mot de passe SCV depuis la console de maintenance
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Si vous ne connaissez pas le mot de passe administrateur de l'interface utilisateur de gestion du SnapCenter Plug-in for VMware vSphere , vous pouvez définir un nouveau mot de passe à partir de la console de maintenance.
