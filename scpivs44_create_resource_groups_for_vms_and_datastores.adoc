...
Pour plus d'informations, reportez-vous à la documentation des ONTAP tools for VMware vSphere .  Pour les versions prises en charge, visitez https://imt.netapp.com/matrix/imt.jsp?components=134348;&solution=1517&isHWU&src=IMT["Matrice d'interopérabilité NetApp"^] .
