...
---
= Créez des groupes de ressources pour les machines virtuelles et les banques de données dans le SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Pour les volumes FlexGroup dans les environnements NetApp MetroCluster, si vous utilisez ONTAP 9.8 ou 9.9, redémarrez le service SnapCenter Plug-in pour VMware vSphere et resynchronisez les relations SnapMirror après un basculement ou un retour en arrière avant de sauvegarder les groupes de ressources. Dans ONTAP 9.8, les sauvegardes peuvent se bloquer après un retour en arrière ; ce problème est résolu dans ONTAP 9.9.
