...
---
= Comment le SCV effectue les opérations de restauration
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: La prise en charge des systèmes de stockage Amazon FSx for NetApp ONTAP est disponible à partir de la version SCV 6.2.
