...
---
= Accédez aux rapports dans le SnapCenter Plug-in for VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
Vous pouvez sélectionner l'icône de téléchargement pour télécharger les journaux du plug-in.
